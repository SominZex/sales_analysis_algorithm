...
class WhatsAppSender:
    def __init__(self, user_data_dir="./whatsapp_session"):
        """
    ...
    def send_pdf_to_group(self, group_name, pdf_path, message="This is an Automated Generated report."):
        """
...
def main():
    ...
    MESSAGE = "This is an Automated Generated report."
